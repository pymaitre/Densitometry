...
After having followed the instructions described in :doc:`installation_procedure`, 
...
the features using total ROI analyses (see :doc:`setting_total_ROI_analyses` for further details).
