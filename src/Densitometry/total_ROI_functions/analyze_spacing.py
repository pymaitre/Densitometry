...
def read_spacing(
    df_py: pd.DataFrame, directory_out: Path, save_sp: bool
...
def histo_spacing(
    coordinate: pd.Series, directory_out: Path, name: str, n_size: float, save_sp: bool
) -> float:
    """
    ...
    if save_sp:
        ...
        count, co, _ = plt.hist(
            coordinate, bins=bin_edges, align="left", color="black", edgecolor="black"
        )
