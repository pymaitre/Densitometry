...
def test_main(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file)])
...
def test_main_no_dcm(reference_conf_total_ROI_analyses:dict,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path"],[None,Path(reference_dir_out),Path(reference_py_patient_file)])
...
def test_main_no_dir_out(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_py_patient_file:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path"],[Path(patient_directory),None,Path(reference_py_patient_file)])
...
def test_main_no_py(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path"],[Path(patient_directory),Path(reference_dir_out),None])
...
def test_main_flag_parallel_not_valid(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","flag_parallel"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),"Yes"])
...
def test_main_N_jobs_small(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","N_jobs"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),0])
...
def test_main_N_jobs_not_valid(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","N_jobs"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),0.5])
...
def test_main_sequential(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    """ Check if sequential approach is chosen. """

    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","flag_parallel"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),False])
...
def test_main_flag_resampling_not_valid(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","flag_resampling"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),"Yes"])
...
def test_main_save_ROI_not_valid(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    """ Provide invalid save_ROI_info. """
    
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","save_ROI_info"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),"Yes"])
...
def test_main_save_ROI_false(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","save_ROI_info"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),False])
...
def test_main_empty_list_roi(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    """ Test when list_roi is empty. """
    
    
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","list_roi"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),[]])
...
def test_main_total_ROI_not_valid(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","total_ROI_analyses"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),"Yes"])
...
def test_main_show_info_not_valid(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","show_total_ROI_info"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),"Yes"])
...
def test_main_save_info_not_valid(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","save_total_ROI_info"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),"Yes"])
...
def test_main_no_res(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path,flag_res:bool,flag_tot:bool):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","flag_resampling","total_ROI_analyses"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),flag_res,flag_tot])
...
def test_main_resample_new_space(reference_conf_total_ROI_analyses:dict,patient_directory:Path,reference_dir_out:Path,reference_py_patient_file:Path,flag:str):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out", "directory_out","py_patient_path","flag_resampling","flag_new_spacing"],[Path(patient_directory),Path(reference_dir_out),Path(reference_py_patient_file),True,flag])
