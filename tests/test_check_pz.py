...
def test_main(patient_directory:Path, reference_py_patient_file:Path,reference_conf_total_ROI_analyses:Path):
    
    """ Test the main function of check_pz. """

    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out","py_patient_path"],[Path(patient_directory),Path(reference_py_patient_file)])      
...
def test_main_no_dcm_out(reference_py_patient_file:Path,reference_conf_total_ROI_analyses:Path):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out","py_patient_path"],[None,Path(reference_py_patient_file)])
...
def test_main_no_py_file(patient_directory:Path,reference_conf_total_ROI_analyses:dict):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out","py_patient_path"],[Path(patient_directory),None])
...
def test_main_not_valid_dcm_out(reference_py_patient_file:Path,reference_conf_total_ROI_analyses:dict):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out","py_patient_path"],[Path("C:\\User\\user\\not_valid_dcm"),Path(reference_py_patient_file)])
...
def test_main_not_valid_py(patient_directory:Path,reference_conf_total_ROI_analyses:dict):
    ...
    reference_conf=modify_configuration_file(reference_conf_total_ROI_analyses,["directory_dcm_out","py_patient_path"],[Path(patient_directory),Path("C:\\User\\user\\not_valid_py_patient_path")])
